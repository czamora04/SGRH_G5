...
import Controladores.autenticacionCTR;
import Controladores.sgrhCTR;
import javax.swing.JOptionPane;

public class sgrhFRMAUTH extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SISTEMA GENERAL DE RECURSOS HUMANOS");
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        if (autenticacionCTR.consultarUsuario(txtUsuario.getText(), txtPass)){
            JOptionPane.showMessageDialog(null, "Bienvenido", "Exito", JOptionPane.INFORMATION_MESSAGE);
            sgrhFRM vista = new sgrhFRM();
            sgrhCTR controller = new sgrhCTR(vista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sgrhFRMAUTH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sgrhFRMAUTH().setVisible(true);
            }
        });
    }
